 ...
 * This file demonstrates how to integrate Fluxquill with a web frontend
 */

// For React/Vue/Angular applications
export class FluxquillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FluxquillClient(provider, contractAddress);
